...
function yreg_estate_init_actions() {
  ...
  if (
    YREG_ESTATE_STORAGE["vc_edit_mode"] &&
    jQuery(".vc_empty-placeholder").length == 0 &&
    YREG_ESTATE_STORAGE["theme_init_counter"]++ < 30
  ) {
...
function yreg_estate_ready_actions() {
  ...
  jQuery(".widget_calendar").on(
    ...
    function (e) {
      ...
      jQuery
        .post(YREG_ESTATE_STORAGE["ajax_url"], {
  ...
  if (menu_side.length > 0) {
    ...
    yreg_estate_show_current_menu_item(
  ...
  if (menu_main.length > 0) {
    var menu_responsive = menu_main
      .clone()
      .removeAttr("id")
      .removeClass("menu_main_nav")
      .addClass("menu_main_responsive"); //.insertAfter('ul#menu_main');
    menu_main.parent().parent().append(menu_responsive);
    yreg_estate_show_current_menu_item(
      jQuery(".menu_main_responsive"),
      jQuery(
        ".top_panel_style_1 .menu_main_responsive_button, .top_panel_style_2 .menu_main_responsive_button"
      )
    );
  }
  ...
  jQuery(
    ".menu_main_responsive_button, .sidebar_outer_menu_responsive_button"
  ).on("click", function (e) {
    "use strict";
  ...
  jQuery(
    ".menu_main_responsive .menu-item-has-children > a, .menu_side_responsive .menu-item-has-children > a, .menu_pushy_nav_area .menu-item-has-children > a, body:not(.woocommerce) .sidebar .widget_product_categories ul.product-categories .has_children > a"
  ).prepend('<span class="open_child_menu"></span>');

  // Submenu click handler for the responsive menu
  jQuery(
    ".menu_main_responsive, .menu_side_responsive, .menu_pushy_nav_area, body:not(.woocommerce) .sidebar .widget_product_categories"
  ).on(
    "click",
    ...
    function (e) {
      "use strict";
      var is_menu_main =
        jQuery(this).parents(".menu_main_responsive").length > 0;
      var $a = jQuery(this).hasClass("open_child_menu")
        ? jQuery(this).parent()
        : jQuery(this);
      if (
        (!is_menu_main || jQuery("body").hasClass("responsive_menu")) &&
  ...
  yreg_estate_init_sfmenu(
    ".menu_main_nav_area ul#menu_main, ul#menu_user, ul#menu_side, body:not(.woocommerce) .sidebar .widget_product_categories ul.product-categories"
  );
  ...
  viewmore_link.on("click", function (e) {
    "use strict";
    if (
      !YREG_ESTATE_STORAGE["viewmore_busy"] &&
  ...
  jQuery(".bookmarks_add").on("click", function (e) {
    ...
    if (!exists) {
      var message_popup = yreg_estate_message_dialog(
        '<label for="bookmark_title">' +
          YREG_ESTATE_STORAGE["strings"]["bookmark_title"] +
          '</label><br><input type="text" id="bookmark_title" name="bookmark_title" value="' +
          title +
          '">',
        YREG_ESTATE_STORAGE["strings"]["bookmark_add"],
        null,
        function (btn, popup) {
          "use strict";
          if (btn != 1) return;
          ...
          jQuery(".bookmarks_list").append(
            '<li><a href="' +
              ...
              YREG_ESTATE_STORAGE["strings"]["bookmark_del"] +
              '"></span></a></li>'
          );
          jQuery.cookie("yreg_estate_bookmarks", JSON.stringify(list), {
            expires: 365,
            path: "/",
          });
          setTimeout(function () {
            yreg_estate_message_success(
              YREG_ESTATE_STORAGE["strings"]["bookmark_added"],
              YREG_ESTATE_STORAGE["strings"]["bookmark_add"]
            );
          }, YREG_ESTATE_STORAGE["message_timeout"] / 4);
        }
      );
    } else yreg_estate_message_warning(YREG_ESTATE_STORAGE["strings"]["bookmark_exists"], YREG_ESTATE_STORAGE["strings"]["bookmark_add"]);
    e.preventDefault();
    return false;
  });
  ...
  if (window.yreg_estate_init_hidden_elements)
    yreg_estate_init_hidden_elements(jQuery("body").eq(0));
} //end ready
...
function yreg_estate_scroll_actions() {
  ...
  // Call theme specific action (if exists)
  //----------------------------------------------
  if (window.yreg_estate_theme_scroll_actions)
    yreg_estate_theme_scroll_actions();

  var scroll_offset = jQuery(window).scrollTop();
  var scroll_to_top_button = jQuery(".scroll_to_top");
  var adminbar_height = Math.max(0, jQuery("#wpadminbar").height());

  if (YREG_ESTATE_STORAGE["top_panel_height"] == 0)
    YREG_ESTATE_STORAGE["top_panel_height"] =
    ...
    if (jQuery(".top_panel_below .slider_wrap").length > 0) {
      ...
      if (slider_height < 10) {
        slider_height = jQuery(".slider_wrap").hasClass(".slider_fullscreen")
          ...
          : YREG_ESTATE_STORAGE["slider_height"];
      }
    }
    if (
      scroll_offset <=
      slider_height + YREG_ESTATE_STORAGE["top_panel_height"]
    ) {
  ...
  if (sidebar_outer.length > 0) {
    if (YREG_ESTATE_STORAGE["side_panel_height"] == 0)
      YREG_ESTATE_STORAGE["side_panel_height"] =
    ...
    if (
      ...
      YREG_ESTATE_STORAGE["side_panel_height"] + 100
    ) {
  ...
  jQuery("#toc .toc_item").each(function () {
    ...
    if (
      ...
      scroll_offset + YREG_ESTATE_STORAGE["top_panel_height"] < off_next
    )
...
function yreg_estate_resize_actions() {
  ...
  // Call theme specific action (if exists)
  //----------------------------------------------
  if (window.yreg_estate_theme_resize_actions)
    yreg_estate_theme_resize_actions();
...
function yreg_estate_responsive_menu() {
  ...
  if (yreg_estate_is_responsive_need(YREG_ESTATE_STORAGE["menu_responsive"])) {
    if (!body.hasClass("responsive_menu")) {
      ...
      if (body.hasClass("menu_relayout")) body.removeClass("menu_relayout");
    ...
    else if (body.hasClass("menu_relayout")) body.removeClass("menu_relayout");
  }
  var top_panel_wrap = jQuery(".top_panel_wrap");
  if (!top_panel_wrap.hasClass("menu_show"))
    top_panel_wrap.addClass("menu_show");
  // Show widgets block on the sidebar outer (if sidebar not responsive and widgets are hidden)
  var sidebar_outer = jQuery(".sidebar_outer");
  if (
    sidebar_outer.length > 0 &&
    sidebar_outer.css("position") == "absolute" &&
...
function yreg_estate_resize_video_background() {
  ...
  if (
    YREG_ESTATE_STORAGE["media_elements_enabled"] &&
...
function yreg_estate_init_sfmenu(selector) {
  jQuery(selector)
    ...
    .each(function () {
      "use strict";
      if (
        yreg_estate_is_responsive_need() &&
      ...
      jQuery(this)
        ...
        .superfish({
          ...
          speed: YREG_ESTATE_STORAGE["css_animation"]
            ? 500
            : YREG_ESTATE_STORAGE["menu_slider"]
            ? 300
            : 200,
          speedOut: YREG_ESTATE_STORAGE["css_animation"]
            ? 500
            : YREG_ESTATE_STORAGE["menu_slider"]
            ? 300
            : 200,
          ...
          onBeforeShow: function (ul) {
            ...
            if (YREG_ESTATE_STORAGE["css_animation"]) {
              jQuery(this).removeClass(
                "animated fast " + YREG_ESTATE_STORAGE["menu_animation_out"]
              );
              jQuery(this).addClass(
                "animated fast " + YREG_ESTATE_STORAGE["menu_animation_in"]
              );
            }
          },
...
function yreg_estate_build_page_toc() {
  ...
  if (
    toc_count >
    (YREG_ESTATE_STORAGE["toc_menu_home"] ? 1 : 0) +
      (YREG_ESTATE_STORAGE["toc_menu_top"] ? 1 : 0)
  ) {
  ...
  for (var m in menus) {
    ...
    menus[m].find('a[href="' + href + '"]').each(function (idx) {
      ...
      while ((li = li.parents("li")).length > 0) {
        cnt++;
        li.addClass(
          "current-menu-ancestor" + (cnt == 1 ? " current-menu-parent" : "")
        );
      }
    });
  }
...
function yreg_estate_init_isotope() {
  ...
  isotope_wrap_n.each(function () {
    "use strict";
    all_images_complete =
      all_images_complete && yreg_estate_check_images_complete(jQuery(this));
  });
  // Wait for images loading
  if (
    !all_images_complete &&
    YREG_ESTATE_STORAGE["isotope_init_counter"]++ < 30
  ) {
  ...
  jQuery(".isotope_filters:not(.inited)")
    ...
    .on("click", "a", function (e) {
      ...
      var viewmore_link = jQuery("#viewmore_link");
      if (selector == "*") viewmore_link.fadeIn();
      else viewmore_link.fadeOut();
...
function yreg_estate_init_appended_isotope(posts_container, filters) {
  ...
  if (
    !yreg_estate_check_images_complete(posts_container) &&
    YREG_ESTATE_STORAGE["isotope_init_counter"]++ < 30
  ) {
    setTimeout(function () {
      yreg_estate_init_appended_isotope(posts_container, filters);
    }, 200);
    return;
  }
  // Add filters
...
function yreg_estate_init_post_formats() {
  ...
  // Call theme specific action (if exists)
  if (window.yreg_estate_theme_init_post_formats)
    yreg_estate_theme_init_post_formats();
  ...
  if (post_counters_likes_n.length > 0) {
    post_counters_likes_n.addClass("inited").on("click", function (e) {
      "use strict";
        ...
        .done(function (response) {
          ...
          if (rez.error === "") {
            ...
            yreg_estate_message_warning(
              YREG_ESTATE_STORAGE["strings"]["error_like"]
            );
          }
        });
      e.preventDefault();
      ...
      jQuery(this)
        ...
        .on("click", function (e) {
          ...
          var video = jQuery(this)
            .removeClass("sc_video_play_button hover_icon_play")
            .addClass("runvideo")
            .data("video");
          if (video !== "") {
...
function yreg_estate_init_media_elements(cont) {
  ...
  if (
    ...
    if (window.mejs) {
      ...
      setTimeout(function () {
        yreg_estate_init_media_elements(cont);
      }, 400);
  }
}
...
function yreg_estate_show_system_message() {
  ...
  if (
    ...
    YREG_ESTATE_STORAGE["system_message"]["message"]
  ) {
    if (YREG_ESTATE_STORAGE["system_message"]["status"] == "success")
      yreg_estate_message_success(
        YREG_ESTATE_STORAGE["system_message"]["message"],
        YREG_ESTATE_STORAGE["system_message"]["header"]
      );
      ...
      YREG_ESTATE_STORAGE["system_message"]["status"] == "error" ||
      YREG_ESTATE_STORAGE["system_message"]["status"] == "warning"
    )
      yreg_estate_message_warning(
        YREG_ESTATE_STORAGE["system_message"]["message"],
        YREG_ESTATE_STORAGE["system_message"]["header"]
...
function yreg_estate_toggle_popup(popup) {
  "use strict";
  if (popup.css("display") != "none") yreg_estate_hide_popup(popup);
  else yreg_estate_show_popup(popup);
}
  ...
  if (popup.css("display") == "none") {
    if (YREG_ESTATE_STORAGE["css_animation"])
      popup
        ...
        .addClass("animated fast " + YREG_ESTATE_STORAGE["menu_animation_in"]);
  ...
  if (popup.css("display") != "none") {
    if (YREG_ESTATE_STORAGE["css_animation"])
      popup
        ...
        .addClass("animated fast " + YREG_ESTATE_STORAGE["menu_animation_out"])
        .delay(500)
        .hide();
    else popup.fadeOut();
  }
    ...
    rules: [
      {
        ...
        min_length: {
          value: 1,
          message: YREG_ESTATE_STORAGE["strings"]["name_empty"],
        },
        max_length: {
          value: 60,
          message: YREG_ESTATE_STORAGE["strings"]["name_long"],
        },
      },
      {
        field: "email",
        min_length: {
          value: 7,
          message: YREG_ESTATE_STORAGE["strings"]["email_empty"],
        },
        max_length: {
          value: 60,
          message: YREG_ESTATE_STORAGE["strings"]["email_long"],
        },
        mask: {
          value: YREG_ESTATE_STORAGE["email_mask"],
          message: YREG_ESTATE_STORAGE["strings"]["email_not_valid"],
        },
      },
      {
        field: "comment",
        min_length: {
          value: 1,
          message: YREG_ESTATE_STORAGE["strings"]["text_empty"],
        },
        max_length: {
          value: YREG_ESTATE_STORAGE["comments_maxlength"],
    ...
    rules: [
      {
        ...
        min_length: {
          value: 1,
          message: YREG_ESTATE_STORAGE["strings"]["login_empty"],
        },
        max_length: {
          value: 60,
          message: YREG_ESTATE_STORAGE["strings"]["login_long"],
        },
      },
      {
        field: "pwd",
        min_length: {
          value: 4,
          message: YREG_ESTATE_STORAGE["strings"]["password_empty"],
        },
        max_length: {
          value: 30,
          message: YREG_ESTATE_STORAGE["strings"]["password_long"],
        },
      },
    ],
  });
      ...
      .done(function (response) {
        ...
        if (rez.error === "") {
          result_box
            ...
            .html(YREG_ESTATE_STORAGE["strings"]["login_success"]);
          setTimeout(function () {
            location.reload();
          }, 3000);
        } else {
          result_box
            ...
            .html(
              YREG_ESTATE_STORAGE["strings"]["login_failed"] +
                "<br>" +
                rez.error
            );
        }
    ...
    rules: [
      ...
      },
      {
        ...
        equal_to: {
          ...
          message: YREG_ESTATE_STORAGE["strings"]["password_not_equal"],
        },
      },
    ],
  });
    ...
    jQuery
      ...
      .done(function (response) {
        ...
        if (rez.error === "") {
          result_box
            .addClass("sc_infobox sc_infobox_style_success")
            .html(YREG_ESTATE_STORAGE["strings"]["registration_success"]);
          setTimeout(function () {
          ...
          result_box
            .addClass("sc_infobox sc_infobox_style_error")
            .html(
              YREG_ESTATE_STORAGE["strings"]["registration_failed"] +
                " " +
                rez.error
            );
        }
    ...
    error = yreg_estate_form_validate(form, {
      ...
      rules: [
        ...
        },
        {
          ...
          min_length: {
            value: 1,
            message: YREG_ESTATE_STORAGE["strings"]["subject_empty"],
          },
          max_length: {
            value: 100,
            message: YREG_ESTATE_STORAGE["strings"]["subject_long"],
          },
        },
        {
          field: "message",
          ...
          max_length: {
            value: YREG_ESTATE_STORAGE["contacts_maxlength"],
            message: YREG_ESTATE_STORAGE["strings"]["text_long"],
          },
        },
      ],
    ...
    jQuery
      ...
      .done(function (response) {
        ...
        if (rez.error === "") {
          form.get(0).reset();
          result
            .addClass("sc_infobox_style_success")
            .html(YREG_ESTATE_STORAGE["strings"]["send_complete"]);
          ...
          result
            ...
            .html(
              YREG_ESTATE_STORAGE["strings"]["send_error"] + " " + rez.error
            );
        }
  ...
  jQuery("#slider-range-area").slider({
    ...
    slide: function (event, ui) {
      ...
      if (ui.values[0] == 0 && ui.values[1] == js_area_big) {
        ...
        jQuery(".ps_area_info_value").html(
  ...
  jQuery("#slider-range-price").slider({
    ...
    slide: function (event, ui) {
      ...
      if (ui.values[0] == 0 && ui.values[1] == js_price_big) {
        ...
        jQuery(".ps_price_info_value").html(
...
function date_time() {
  ...
  jQuery(".custom_form_slider_item .cfs_time").appendTo(
    ".custom_form_slider_item .cfs_date_time"
  );
}
