...
!(function (a) {
  ...
  (function (a) {
    ...
    "function" == typeof define && define.amd
      ...
      : c(a.Isotope.LayoutMode, a.Masonry);
  })(window),
  (function (a) {
    function b(a) {
    ...
    function f(a, c, f, i, k) {
      ...
      (m.Item = i),
        ...
        (m.prototype._itemize = function () {
          for (
            var b = a.prototype._itemize.apply(this, arguments),
              c = 0,
              d = b.length;
            d > c;
            c++
        ...
        (m.prototype._initLayoutMode = function (a) {
          var c = k.modes[a],
            d = this.options[a] || {};
          (this.options[a] = c.options ? b(c.options, d) : d),
            (this.modes[a] = new c(this));
        }),
        ...
        (m.prototype._filter = function (a) {
          ...
          for (
            ...
            if (!j.isIgnored) {
              var k = g(j);
              k && d.push(j),
                k && j.isHidden ? e.push(j) : k || j.isHidden || f.push(j);
            }
          }
          var l = this;
      ...
      (m.sortDataParsers = {
        ...
        (m.prototype.prepended = function (a) {
          ...
          if (b.length) {
            ...
            this.layoutItems(c),
              (this.filteredItems = d.concat(this.filteredItems));
          }
        }),
