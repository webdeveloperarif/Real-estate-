...
(function (e, t, n, r) {
  ...
  n.extend(u, {
    ...
    defaults: {
      ...
      tpl: {
        ...
        iframe:
          '<iframe id="esgbox-frame{rnd}" name="esgbox-frame{rnd}" class="esgbox-iframe" frameborder="0" vspace="0" hspace="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen' +
          (a ? ' allowtransparency="true"' : "") +
          "></iframe>",
        error:
          '<p class="esgbox-error">The requested content cannot be loaded.<br/>Please try again later.</p>',
        closeBtn:
          '<a title="Close" class="esgbox-item esgbox-close" href="javascript:;"></a>',
    ...
    toggle: function (e) {
      if (u.isOpen) {
        u.current.fitToView =
          n.type(e) === "boolean" ? e : !u.current.fitToView;
        if (l) {
    ...
    showLoading: function () {
      var e, t;
      u.hideLoading();
      e = n('<div id="esgbox-loading"><div></div></div>')
        .click(u.cancel)
        .appendTo("body");
    ...
    _afterLoad: function () {
      ...
      if (t) {
        ...
        t.wrap
          .stop(true)
          .removeClass("esgbox-opened")
          .find(".esgbox-item, .esgbox-nav")
          .remove();
      }
      u.unbindEvents();
      i = e;
      ...
      switch (o) {
        ...
        case "swf":
          s =
            '<object id="esgbox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="' +
            f +
            '"></param>';
          l = "";
  ...
  u.helpers.overlay = {
    ...
    create: function (e) {
      ...
      this.overlay = n('<div class="esgbox-overlay"></div>').appendTo(
          ...
          n("*")
            .filter(function () {
              return (
                ...
                !n(this).hasClass("esgbox-overlay") &&
                !n(this).hasClass("esgbox-wrap")
              );
            })
  ...
  u.helpers.title = {
    ...
    beforeShow: function (e) {
      ...
      s = n(
        '<div class="esgbox-title esgbox-title-' + i + '-wrap">' + r + "</div>"
      );
      switch (i) {
        case "inside":
          o = u.skin;
  ...
  n.fn.esgbox = function (e) {
    var t,
      ...
      s = function (s) {
        var o = n(this).blur(),
          ...
          l;
        if (
          !(s.ctrlKey || s.altKey || s.shiftKey || s.metaKey) &&
          !o.is(".esgbox-wrap")
        ) {
    ...
    if (!i || e.live === false) {
      ...
      o.undelegate(i, "click.fb-start").delegate(
        i + ":not('.esgbox-item, .esgbox-nav')",
        "click.fb-start",
        s
      );
    }
  ...
  o.ready(function () {
    ...
    n(
      "<style type='text/css'>.esgbox-margin{margin-right:" +
        (s - t) +
        "px;}</style>"
    ).appendTo("head");
  });
        ...
        if (t.hasOwnProperty(o)) {
          ...
          if (a) {
            ...
            f = e.extend(
              ...
              {},
              u.params,
              r[o] || (e.isPlainObject(t[o]) ? t[o].params : null)
            );
            i =
              e.type(u.url) === "function"
                ? u.url.call(this, a, f, r)
                : n(u.url, a, f);
            break;
          }
        }
    ...
    init: function (t, n) {
      ...
      for (var a = 0; a < n.group.length; a++) {
        i +=
          ...
          "px;height:" +
          o +
          'px;" href="javascript:jQuery.esgbox.jumpto(' +
          a +
          ');"></a></li>';
      }
      this.wrap = e('<div id="esgbox-thumbs"></div>')
        .addClass(t.position)
        .appendTo("body");
      ...
      this.list
        ...
        .css(
          "left",
          Math.floor(
            e(window).width() * 0.5 - (n.index * this.width + this.width * 0.5)
          )
        );
    },
    beforeLoad: function (e, t) {
